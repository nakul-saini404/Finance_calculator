...
export const HOME_CARDS = [
  { id: 'emi',  icon: '🏦', title: 'EMI Calculator',   desc: 'Monthly installments for home, car & personal loans with amortization breakdown.', tag: 'Most Used',     tagColor: '#34d399', tagBg: 'rgba(52,211,153,0.12)',  borderColor: 'rgba(52,211,153,0.2)',  accentColor: '#34d399' },
  { id: 'gst',  icon: '🧾', title: 'GST Calculator',   desc: 'Add or remove GST instantly. Full CGST/SGST/IGST split for all Indian tax rates.', tag: '🔥 India',      tagColor: '#fbbf24', tagBg: 'rgba(251,191,36,0.12)', borderColor: 'rgba(251,191,36,0.2)',  accentColor: '#fbbf24' },
  { id: 'tax',  icon: '📋', title: 'Income Tax',       desc: 'FY 2025–26 tax computation. Old vs New regime comparison with net take-home.', tag: 'FY 2025–26',   tagColor: '#60a5fa', tagBg: 'rgba(96,165,250,0.12)',  borderColor: 'rgba(96,165,250,0.2)',  accentColor: '#60a5fa' },
  { id: 'sip',  icon: '📈', title: 'SIP Calculator',   desc: 'Project SIP wealth over time with step-up mode, milestones & inflation-adjusted returns.', tag: 'Mutual Funds', tagColor: '#c084fc', tagBg: 'rgba(192,132,252,0.12)', borderColor: 'rgba(192,132,252,0.2)', accentColor: '#c084fc' },
  { id: 'loan', icon: '✅', title: 'Loan Eligibility', desc: 'Know your maximum loan amount. FOIR-based with CIBIL score adjustment.', tag: 'Bank Check',   tagColor: '#2dd4bf', tagBg: 'rgba(45,212,191,0.12)', borderColor: 'rgba(45,212,191,0.2)', accentColor: '#2dd4bf' },
];