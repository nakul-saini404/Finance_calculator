  ...
  return (
    <Box sx={{ p: '30px 28px', overflowY: 'auto', height: 'calc(100vh - 56px)' }}>
      ...
      >
        ...
        <Box
          sx={{
            background: 'repeating-linear-gradient(45deg, #0f1018, #0f1018 10px, #131620 10px, #131620 20px)',
        ...
        >
          ...
          <Typography sx={{ fontFamily: "'Syne', sans-serif", fontSize: 15.5, fontWeight: 700, color: '#eef0fa', mb: 0.75 }}>
            More Coming Soon
          </Typography>
          <Typography sx={{ fontSize: 12.5, color: '#8b8fa8', lineHeight: 1.65, mb: 1.5 }}>
            PPF, FD, NPS, HRA, Compound Interest & more launching soon.
          </Typography>
          <Box
            sx={{
              display: 'inline-block', fontSize: 9.5, fontWeight: 700,
              letterSpacing: '0.6px', px: 1, py: 0.375, borderRadius: '8px',
              background: '#1a1d2e', color: '#4e5168',
            }}
          >
            SOON
          </Box>
